...
import { XmlParseService } from 'src/app/shared/xml-parse.service';
...
export class ForecastComponent implements OnInit {
    ...
    constructor(
        private _serviceForecast: ForecastService,
        private _serviceXmlParse: XmlParseService) {}

    // TODO:
    // set/get user defined parameters
    // poll service on interval
    // display results/alert for weather 'window'
    // stretch: show animated weather map
    ngOnInit(): void {
        this._serviceForecast
            .getWeatherData(40.1502, -79.5423)
            .subscribe(
                response => {
                    ...
                    const forecastObj = this._serviceXmlParse.xmlParse(xml.children[0]);
